...
pubDate: "Feb 13 2026"
heroImage: "../assets/simplify-creating-interactive-activities/graph_de_zoomed_in.png"
---
...
and out pops a graph that matches my criteria. (In the below display, you can modify the instructions in the left panel and click the Update button to see the result.)

export const functionWithMaximum = `<graph>
  <function maxima="(-4,2) (3,7)" />
</graph>
`;

<DoenetEditor
  doenetML={functionWithMaximum}
  client:only="react"
  showFormatter={false}
