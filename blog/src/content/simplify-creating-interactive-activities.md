...
pubDate: "Feb 11 2026"
heroImage: "../assets/simplify-creating-interactive-activities/directional-derivative-gradients.png"
---
...
For students to engage, I want them to interact with the graph to solve a problem. Maybe I want them to draw a graph of a function that has a single maximum of about 6. This shouldn't be that much more difficult for me to specify. I have to give them three moveable points, say $A$, $B$, and $C$, and a function $f$ through those points. In Doenet, we could describe this relationship with the following:
...
Doenet would count this graph as correctly meeting the criteria.

![A graph sketched by a student with a maximum around (-5, 6). The sketched is marked as Correct.](../assets/simplify-creating-interactive-activities/student-sketch-function-with-maximum.png)
