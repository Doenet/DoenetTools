...
export async function loader({ params }) {
  console.log('getPortfolioEditor', params);
  ...
  //If no 'noPageId' then look for one in the content
  //If can't find one then doenetML will be blank
...
export function PortfolioActivityEditor() {
  ...
  return <div>PortfolioActivityEditor</div>;
