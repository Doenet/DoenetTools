  ...
  let dataStructure = [
    ...
    },
    {
      ...
      props: [
          ...
          {name: 'onChange',
          propPreview: '<DateTime onChange={(({ value }) => console.log(">>>", value)} />',
          propCode: {onChange: ({ dateObjectState }) => console.log(">>>", dateObjectState)},
    ...
    },
    {
      ...
      props: [
        ...
        {name: 'Default Index',
        propPreview: '<DropdownMenu items = {[[1, "one"], [2, "two"]]} defaultIndex={"1"}/>',
        propCode: {items: [[1, "one"], [2, "two"]], defaultIndex: '1'},
