      ...
      <ToastProvider>
        ...
        <ToolLayout 
          ...
          >
            ...
            <SplitLayoutPanel 
                 defaultVisible={true} 
                 panelHeaderControls={[ <button  style={{ height:'24px', padding:'1px'}} onClick={() => this.toggleSplitPanel()}><FontAwesomeIcon icon={faTimesCircle} style={{ fontSize: "17px" , height:'15px', padding:'2px'}}/></button>]}>
