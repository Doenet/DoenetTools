...
// }
  ...
  return (
    <>
      <DoenetHeader guestUser={true} toolName={props.toolName} headingTitle={props.headingTitle} headerRoleFromLayout={props.headerRoleFromLayout} headerChangesFromLayout={props.headerChangesFromLayout} onChange={showCollapseMenu} />
