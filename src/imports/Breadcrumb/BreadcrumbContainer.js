...
import { faTh, faAngleRight } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';

export const BreadcrumbContainer = ({ divider = <FontAwesomeIcon icon={faAngleRight}/>, ...props }) => {
