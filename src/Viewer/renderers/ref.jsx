...
export default class Ref extends DoenetRenderer {
  ...
  render() {
    ...
    if (this.doenetSvData.contentId) {
      return <a id={this.componentName} name={this.componentName} href={`https://www.doenet.org/content/#/?contentId=${this.doenetSvData.contentId}`}>{linkContent}</a>
    } else if (this.doenetSvData.doenetId) {
      return <a id={this.componentName} name={this.componentName} href={`https://www.doenet.org/content/#/?doenetId=${this.doenetSvData.doenetId}`}>{linkContent}</a>
