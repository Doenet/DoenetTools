...
export default function Tooltip(props) {
  ...
  var text =
    "You’ve found a tooltip where we haven’t given you any additional information. Yikes! If you’re super nice, you can contact us and let us know. Otherwise, let’s just pretend like this never happened...";
  if (props.text) {
    text = props.text;
  }
