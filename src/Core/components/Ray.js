      ...
      definition: function ({ dependencyValues }) {
        ...
        if (dependencyValues.basedOnDirection) {
          if (dependencyValues.directionAttr !== null) {
            ...
            if (Array.isArray(directionTree) && ["tuple", "vector", "altvector"].includes(directionTree[0])) {
      ...
      definition: function ({ dependencyValues }) {
        ...
        if (dependencyValues.basedOnThrough) {
          if (dependencyValues.throughAttr !== null) {
            ...
            if (Array.isArray(throughTree) && ["tuple", "vector", "altvector"].includes(throughTree[0])) {
      ...
      definition: function ({ dependencyValues }) {
        ...
        if (dependencyValues.basedOnEndpoint) {
          if (dependencyValues.endpointAttr !== null) {
            ...
            if (Array.isArray(endpointTree) && ["tuple", "vector", "altvector"].includes(endpointTree[0])) {
