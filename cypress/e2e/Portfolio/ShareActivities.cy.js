...
describe("doenetEditor test", function () {
  ...
  it("Share activities and remix", () => {
    ...
    // cy.get('[data-test="Private Activities"] [data-test="Activity Card"] [data-test="Menu Button"]').click();

  });

  it.only("Share activities and remix", () => {
    cy.get('[data-test="Portfolio"]').click();
    ...
    cy.get('[data-test="Public Activities"] [data-test="Card Menu Button"]').click();
    ...
    cy.get('[data-test="Search Results For"]').should('have.text', 'Stay Private');
    ...
    cy.get('[data-test="Search"]').clear().should('have.value', '').type("Hello!{enter}");
    cy.get('[data-test="Search Results For"]').should('have.text', 'Hello!');



    cy.get('[data-test="Results All Matches"] [data-test="Card Image Link"] ').eq(0).click();
    ...
    // cy.get(".cm-content").type(
    //   `{ctrl+end}<p name="actual_change">Actual change</p>`,
    // );
    // cy.get('[data-test="Viewer Update Button"]').click();
    ...
    // cy.log("Edit the activity");
    // cy.get('[data-test="Private Activities"] [data-test="Activity Card"]')
    //   .eq(0)
    //   .find("img")
    //   .eq(0)
    //   .click();
    ...
    // cy.get('[data-test="Support Panel Controls"]')
    //   .contains("Button", "Update Public Activity")
    //   .click();
    ...
    // cy.get('[data-test="Search Results"] [data-test="Activity Card"]')
    //   .eq(0)
    //   .find("img")
    //   .click();
