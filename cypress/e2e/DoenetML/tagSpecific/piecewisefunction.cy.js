...
describe('Piecewise Function Tag Tests', function () {
  ...
  it('heaviside function', () => {
    ...
    cy.window().then(async (win) => {
      ...
      for (let fsym of fs) {
        let f = createFunctionFromDefinition(stateVariables["/" + fsym].stateValues.fDefinitions[0]);
      ...
      for (let gsym of gs) {
        let g = createFunctionFromDefinition(stateVariables["/" + gsym].stateValues.fDefinitions[0]);
      ...
      for (let hsym of hs) {
        let h = createFunctionFromDefinition(stateVariables["/" + hsym].stateValues.fDefinitions[0]);
  ...
  it('different variables', () => {
    ...
    cy.window().then(async (win) => {
      ...
      let k = createFunctionFromDefinition(stateVariables["/k"].stateValues.fDefinitions[0]);
  ...
  it('extrema', () => {
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables["/g"].stateValues.minima[0][1]).closeTo(-0.01, 1E-14)
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables["/h2"].stateValues.maxima[0][0]).closeTo(-0.1, 1E-14)
      expect(stateVariables["/h2"].stateValues.maxima[0][1]).closeTo(0.01, 1E-14)
  ...
  it('extrema 2, overlap in domains', () => {
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables["/k2"].stateValues.maxima[0][1]).closeTo(6.25, 1E-8)
      expect(stateVariables["/k2"].stateValues.maxima[1][0]).closeTo(3, 1E-8)
      expect(stateVariables["/k2"].stateValues.maxima[1][1]).closeTo(6.25, 1E-8)
