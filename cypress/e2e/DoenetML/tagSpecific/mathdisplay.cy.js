describe('Math Display Tag Tests', function () {
  ...
  it('m in graph', () => {
    ...
    <text>a</text>
    <graph >
      <m anchor="$anchorCoords1" name="math1" anchorPosition="$anchorPosition1" draggable="$draggable1">\\frac{\\partial f}{\\partial x}</m>
  ...
  it('m3 in graph', () => {
    ...
    <text>a</text>
    <graph >
      <me anchor="$anchorCoords1" name="math1" anchorPosition="$anchorPosition1" draggable="$draggable1">\\frac{\\partial f}{\\partial x}</me>
  ...
  it('me in graph', () => {
    ...
    <text>a</text>
    <graph >
      <md anchor="$anchorCoords1" name="math1" anchorPosition="$anchorPosition1" draggable="$draggable1">
