...
describe('MatrixInput Tag Tests', function () {
  ...
  it('no arguments, copy matrixinput', () => {
    ...
    cy.get(cesc(`#\\/mi1_component_0_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi2_component_0_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    ...
    cy.get(cesc(`#\\/mi1_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi2_component_0_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('a')
    })
    cy.get(cesc(`#\\/mi2_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    ...
    cy.get(cesc('#\\/mi2_component_1_0') + ' textarea').type("b", { force: true })
    ...
    cy.log('type enter')
    cy.get(cesc('#\\/mi2_component_1_0') + ' textarea').type("{enter}", { force: true })
    ...
    cy.get(cesc(`#\\/mi1_component_0_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi1_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('b')
    })
    cy.get(cesc(`#\\/mi1_component_1_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi2_component_0_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('a')
    })
    cy.get(cesc(`#\\/mi2_component_0_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi2_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('b')
    })
    cy.get(cesc(`#\\/mi2_component_1_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[a＿b＿]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[a＿b＿]')
    ...
    cy.get(cesc('#\\/mi2_component_0_1') + ' textarea').type("c", { force: true })
    cy.get(cesc('#\\/mi2_component_1_1') + ' textarea').type("d", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[acb＿]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[acbd]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[acbd]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[acbd]')
    ...
    cy.get(cesc('#\\/mi1_component_0_1') + ' textarea').type("{end}{backspace}e{enter}", { force: true })
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi2_component_0_0') + ' textarea').type("{end}{backspace}f{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[febd]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[febd]')
    ...
    cy.get(cesc('#\\/mi1_component_0_0') + ' textarea').type("{end}{backspace}g", { force: true })
    cy.get(cesc('#\\/mi1_component_0_1') + ' textarea').type("{end}{backspace}h", { force: true })
    cy.get(cesc('#\\/mi2_component_1_0') + ' textarea').type("{end}{backspace}i", { force: true })
    cy.get(cesc('#\\/mi2_component_1_1') + ' textarea').type("{end}{backspace}j", { force: true }).blur()
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[ghij]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[ghij]')
  ...
  it('prefill with matrix', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[abcd]')
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi1_component_0_0') + ' textarea').type("{end}{backspace}z{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[zbcd]')
    ...
    cy.log('change values')
    cy.get(cesc('#\\/mi1_component_0_0') + ' textarea').type("{end}{backspace}e{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_1_0') + ' textarea').type("{end}{backspace}f{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_0_1') + ' textarea').type("{end}{backspace}g{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_1_1') + ' textarea').type("{end}{backspace}h{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[egfh]')
    ...
    cy.get(cesc("#\\/m1") + " .mjx-mrow").should('contain.text', '⎡⎢⎣egfh＿＿⎤⎥⎦')
    ...
    cy.get(cesc(`#\\/mi1_component_2_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi1_component_2_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfh＿＿⎤⎥⎦')
    ...
    cy.get(cesc('#\\/mi1_component_2_0') + ' textarea').type("{end}{backspace}i{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_2_1') + ' textarea').type("{end}{backspace}j{enter}", { force: true })

    cy.get(cesc("#\\/m1") + " .mjx-mrow").should('contain.text', '⎡⎢⎣egfhij⎤⎥⎦')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfhij⎤⎥⎦')
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi1_component_0_0') + ' textarea').type("{end}{backspace}k{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1") + " .mjx-mrow").should('contain.text', '⎡⎢⎣kg＿fh＿ij＿⎤⎥⎦')
    ...
    cy.get(cesc(`#\\/mi1_component_0_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi1_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('f')
    ...
    cy.get(cesc(`#\\/mi1_component_1_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi1_component_2_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('i')
    ...
    cy.get(cesc(`#\\/mi1_component_2_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣kg＿fh＿ij＿⎤⎥⎦')
  ...
  it('prefill with matrix, start smaller', () => {
    ...
    cy.get(cesc(`#\\/numRows`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/numColumns`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi1') + ' textarea').type("{end}{backspace}e{enter}", { force: true });
    ...
    cy.get(cesc('#\\/numColumns') + ' textarea').type("{end}{backspace}2{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[ebfd]')
    ...
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}3{enter}", { force: true })
    ...
    cy.log('down to one entry')
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}1{enter}", { force: true })
    cy.get(cesc('#\\/numColumns') + ' textarea').type("{end}{backspace}1{enter}", { force: true })
    ...
    cy.log('up to 3x3 entry')
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}3{enter}", { force: true })
    cy.get(cesc('#\\/numColumns') + ' textarea').type("{end}{backspace}3{enter}", { force: true })
  ...
  it('prefill with vector', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[e＿f＿]')
  ...
  it('prefill with transpose of vector', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[eb＿＿]')
  ...
  it('prefill with transpose of vector, start smaller', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[ebf＿]')
  ...
  it('bind to matrix', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[abcd]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[abcd]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[egfh]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[egfh]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfh＿＿⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfh＿＿⎤⎥⎦')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfhij⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣egfhij⎤⎥⎦')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣kg＿fh＿ij＿⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣kg＿fh＿ij＿⎤⎥⎦')
  ...
  it('bind to matrix, ignore size via definition', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[ebcd]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[ebcd]')
    ...
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}9{enter}", { force: true })
  ...
  it('bind to vector', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,＿)')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣ef＿⎤⎥⎦')
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi1_component_2_0') + ' textarea').type("{end}{backspace}z{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,z)')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣efz⎤⎥⎦')
    ...
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}4{enter}", { force: true })
    ...
    cy.get(cesc(`#\\/mi1_component_3_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,z,＿)')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢\n⎢\n⎢\n⎢⎣efz＿⎤⎥\n⎥\n⎥\n⎥⎦')
    ...
    cy.log('change values')
    cy.get(cesc('#\\/mi1_component_2_0') + ' textarea').type("{end}{backspace}{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_3_0') + ' textarea').type("{end}{backspace}y{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,＿,y)')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢\n⎢\n⎢\n⎢⎣ef＿y⎤⎥\n⎥\n⎥\n⎥⎦')
    ...
    cy.get(cesc('#\\/numRows') + ' textarea').type("{end}{backspace}2{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[e＿f＿]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[e＿f＿]')
  ...
  it('bind to vector, ignore size via definition', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(a,b,c)')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,c)')
  ...
  it('bind to transpose of vector', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(a,b)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[ab]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g)T')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,＿)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿]')
    ...
    cy.log('change value')
    cy.get(cesc('#\\/mi1_component_0_2') + ' textarea').type("{end}{backspace}z{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,z)T')
    ...
    cy.get(cesc('#\\/numColumns') + ' textarea').type("{end}{backspace}4{enter}", { force: true })
    ...
    cy.get(cesc(`#\\/mi1_component_0_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,z,＿)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[egz＿]')
    ...
    cy.log('change values')
    cy.get(cesc('#\\/mi1_component_0_2') + ' textarea').type("{end}{backspace}{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_0_3') + ' textarea').type("{end}{backspace}y{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,＿,y)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿y]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿＿]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿＿]')
  ...
  it('bind to transpose of vector, alternative format', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g)′')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,＿)′')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,z)′')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[egz]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,z,＿)′')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[egz＿]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,g,＿,y)′')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[eg＿y]')
  ...
  it('bind to transpose of vector, ignore size via definition', () => {
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(a,b,c)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[abc]')
    ...
    cy.log('change values')
    cy.get(cesc('#\\/mi1_component_0_0') + ' textarea').type("{end}{backspace}e{enter}", { force: true })
    cy.get(cesc('#\\/mi1_component_0_1') + ' textarea').type("{end}{backspace}f{enter}", { force: true })
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f,c)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[efc]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '(e,f)T')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[ef]')
    ...
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[ef＿＿]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[ef＿＿]')
  ...
  it('default entry, prefill sparse matrix', () => {
    ...
    cy.get(cesc(`#\\/mi2_component_0_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    ...
    cy.get(cesc(`#\\/mi2_component_1_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_2_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_2_1`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_2_2`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })

    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣00＿03＿＿＿＿⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣000030000⎤⎥⎦')
    ...
    cy.get(cesc("#\\/m1") + " .mjx-mrow").should('contain.text', '⎡⎢⎣00＿＿03＿＿＿＿＿＿⎤⎥⎦')
    ...
    cy.get(cesc(`#\\/mi1_component_1_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    cy.get(cesc(`#\\/mi1_component_2_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    ...
    cy.get(cesc(`#\\/mi1_component_2_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('')
    })
    ...
    cy.get(cesc(`#\\/mi2_component_0_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_1_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    ...
    cy.get(cesc(`#\\/mi2_component_1_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })
    cy.get(cesc(`#\\/mi2_component_2_0`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    ...
    cy.get(cesc(`#\\/mi2_component_2_3`) + ` .mq-editable-field`).invoke('text').then((text) => {
      expect(text.replace(/[\s\u200B-\u200D\uFEFF]/g, '')).equal('0')
    })

    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣00＿＿03＿＿＿＿＿＿⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣000003000000⎤⎥⎦')
  ...
  it('default entry, bind value to sparse matrix', () => {
    ...
    cy.get(cesc("#\\/sparse1")).find('.mjx-mrow').eq(0).should('have.text', '[0003]')
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '[0003]')
    cy.get(cesc("#\\/sparse2")).find('.mjx-mrow').eq(0).should('have.text', '[0003]')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '[0003]')
    ...
    cy.get(cesc("#\\/m1") + " .mjx-mrow").should('contain.text', '⎡⎢⎣00＿03＿＿＿＿⎤⎥⎦')
    cy.get(cesc("#\\/m2") + " .mjx-mrow").should('contain.text', '⎡⎢⎣000030000⎤⎥⎦')
    ...
    cy.get(cesc("#\\/sparse1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣00＿03＿＿＿＿⎤⎥⎦')
    cy.get(cesc("#\\/m1")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣00＿03＿＿＿＿⎤⎥⎦')
    cy.get(cesc("#\\/sparse2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣000030000⎤⎥⎦')
    cy.get(cesc("#\\/m2")).find('.mjx-mrow').eq(0).should('have.text', '⎡⎢⎣000030000⎤⎥⎦')
  ...
  `}, "*");
    ...
    cy.get(cesc('#\\/mcw') + ' .mq-editable-field').should('have.css', 'min-width', "50px");

    cy.get(cesc('#\\/original_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/result_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");

    cy.get(cesc('#\\/mcw') + ' textarea').type("{end}{backspace}100{enter}", { force: true });
    cy.get(cesc('#\\/result_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "100px");
    ...
    cy.get(cesc('#\\/result_component_1_1') + ' .mq-editable-field').should('have.css', 'min-width', "100px");
    cy.get(cesc('#\\/result_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "100px");
    cy.get(cesc('#\\/result_component_0_1') + ' .mq-editable-field').should('have.css', 'min-width', "100px");
    cy.get(cesc('#\\/result_component_1_0') + ' .mq-editable-field').should('have.css', 'min-width', "100px");

    cy.get(cesc('#\\/original_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/original_component_0_1') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/original_component_1_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/original_component_1_1') + ' .mq-editable-field').should('have.css', 'min-width', "0px");


    cy.get(cesc('#\\/mcw') + ' textarea').type("{end}x{enter}", { force: true });

    cy.get(cesc('#\\/result_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/result_component_0_1') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/result_component_1_0') + ' .mq-editable-field').should('have.css', 'min-width', "0px");
    cy.get(cesc('#\\/result_component_1_1') + ' .mq-editable-field').should('have.css', 'min-width', "0px");


    cy.get(cesc('#\\/mcw') + ' textarea').type("{end}{backspace}{backspace}{backspace}7{enter}", { force: true });

    cy.get(cesc('#\\/result_component_0_0') + ' .mq-editable-field').should('have.css', 'min-width', "17px");
    cy.get(cesc('#\\/result_component_0_1') + ' .mq-editable-field').should('have.css', 'min-width', "17px");
    cy.get(cesc('#\\/result_component_1_0') + ' .mq-editable-field').should('have.css', 'min-width', "17px");
    cy.get(cesc('#\\/result_component_1_1') + ' .mq-editable-field').should('have.css', 'min-width', "17px");


    cy.get(cesc('#\\/mcw') + ' textarea').type("{end}{backspace}{backspace}-20{enter}", { force: true });
