...
describe("Slider Tag Tests", function () {
  ...
  <p>
    ...
    cy.get(cesc("#\\/_document1")).trigger("mousemove", numberToPx2(-1), 200, {
      force: true,
    });
    ...
    cy.get(cesc("#\\/_document1")).trigger("mousemove", numberToPx2(7), 300, {
      force: true,
    });
  ...
  <p>Change value: <mathinput name="mi" bindValueTo="$s" /></p>
    ...
    cy.get(cesc("#\\/mi") + " textarea").type("{end}{backspace}4.2{enter}", {
      force: true,
    });
  ...
  <p>Change value: <mathinput name="mi" bindValueTo="$s" /></p>
    ...
    cy.get(cesc("#\\/mi0") + " textarea").type("{end}{backspace}8.7{enter}", {
      force: true,
    });
    ...
    cy.get(cesc("#\\/mi0") + " textarea").type("{end}{backspace}999{enter}", {
      force: true,
    });
