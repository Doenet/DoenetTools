...
describe("Point Tag Tests", function () {
  ...
  `,
    ...
    cy.window().then(async (win) => {
      ...
      expect(
        stateVariables["/A"].stateValues.xs[0] -
          0.1 * stateVariables["/A"].stateValues.xs[1],
      ).closeTo(0, 1e-14);
      expect(
        stateVariables["/B"].stateValues.xs[0] -
          0.1 * stateVariables["/A"].stateValues.xs[1],
      ).closeTo(0, 1e-14);
      expect(stateVariables["/A"].stateValues.constraintUsed).eq(true);
      expect(stateVariables["/B"].stateValues.constraintUsed).eq(true);
    ...
    cy.get(cesc("#\\/xmin") + " textarea").type("{end}{backspace}{enter}", {
      force: true,
    });
    cy.get(cesc("#\\/xmax") + " textarea").type("{end}{backspace}{enter}", {
      force: true,
    });
    ...
    cy.get(cesc("#\\/xmin") + " textarea").type("{end}0{enter}", {
      force: true,
    });
    cy.get(cesc("#\\/xmax") + " textarea").type("{end}0{enter}", {
      force: true,
    });
    ...
    cy.window().then(async (win) => {
      ...
      expect(
        stateVariables["/A"].stateValues.xs[0] +
          100 * stateVariables["/A"].stateValues.xs[1],
      ).closeTo(0, 1e-14);
      expect(
        stateVariables["/B"].stateValues.xs[0] +
          100 * stateVariables["/A"].stateValues.xs[1],
    ...
    cy.get(cesc("#\\/ymin") + " textarea").type("{end}{backspace}{enter}", {
      force: true,
    });
    cy.get(cesc("#\\/ymax") + " textarea").type("{end}{backspace}{enter}", {
      force: true,
    });
