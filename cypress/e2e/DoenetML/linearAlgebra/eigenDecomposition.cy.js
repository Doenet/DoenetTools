...
describe('EigenDecomposition Tag Tests', function () {
  ...
  `}, "*");
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables["/Aevec1x"].stateValues.value / stateVariables["/Aevec1y"].stateValues.value).closeTo(-1, 1E-14)
      ...
      expect(stateVariables["/Bd"].stateValues.eigenvectors[1][1] / stateVariables["/Bd"].stateValues.eigenvectors[1][0]).closeTo(1, 1E-14)

      expect(stateVariables["/Bevec1"].stateValues.displacement[1] / stateVariables["/Bevec1"].stateValues.displacement[0]).closeTo(-1, 1E-14)
      expect(stateVariables["/Bevec1a"].stateValues.displacement[1] / stateVariables["/Bevec1a"].stateValues.displacement[0]).closeTo(-1, 1E-14)
      expect(stateVariables["/Bevec2"].stateValues.displacement[1] / stateVariables["/Bevec2"].stateValues.displacement[0]).closeTo(1, 1E-14)
      expect(stateVariables["/Bevec2a"].stateValues.displacement[1] / stateVariables["/Bevec2a"].stateValues.displacement[0]).closeTo(1, 1E-14)
      expect(stateVariables["/Bevec1x"].stateValues.value / stateVariables["/Bevec1y"].stateValues.value).closeTo(-1, 1E-14)
