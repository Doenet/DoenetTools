...
describe('factor polynomial tests, old algorithm', function () {
  ...
  it('factor 4x^2-4', () => {
    ...
    cy.log('(6x-6)(8x+8)/6')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(6x-6)(8x+8)/6{enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_incorrect')).should('be.visible')


    cy.log('0.5(6x-6)(4x+4)/3')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}0.5(6x-6)(4x+4)/3{enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')
  ...
  it('factor (3q+2r)(6s+8t)', () => {
    ...
    cy.log('(3q+2r)(6s+8t)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(3q+2r)(6s+8t){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')

    cy.log('3q(6s+8t) + 2r(6s+8t)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}3q(6s+8t) + 2r(6s+8t){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_incorrect')).should('be.visible')

    cy.log('(6s+8t)(3q+2r)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(6s+8t)(3q+2r){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')

    cy.log('(8t+6s)(3q+2r)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(8t+6s)(3q+2r){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')

    cy.log('(8t+6s)(2r+3q)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(8t+6s)(2r+3q){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')

    cy.log('(8t+6s)(2r+q+q+q)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(8t+6s)(2r+q+q+q){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')

    cy.log('(4t+3s)2(2r+3q)')
    cy.get(cesc('#\\/ans') + ' textarea').type('{ctrl+home}{shift+end}{backspace}(4t+3s)2(2r+3q){enter}', { force: true });
    cy.get(cesc('#\\/check_submit')).click();
    cy.get(cesc('#\\/check_correct')).should('be.visible')
