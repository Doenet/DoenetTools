...
`
  ...
  it('Finish button submits and saves state ', () => {
    ...
    const doenetML1 = `1: <answer forceFullCheckworkButton>1</answer>`;
    const doenetML2 = `2: <answer forceFullCheckworkButton>2</answer>`;
    const doenetML3 = `3: <answer forceFullCheckworkButton>3</answer>`;
    const doenetML4 = `4: <answer forceFullCheckworkButton>4</answer>`;
