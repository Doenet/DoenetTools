...
describe('Relationships among pages tests', function () {
  ...
  it("Problem numbering continues across pages", () => {
    ...
    cy.get(cesc('#page2\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_problem1_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_problem2_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p2')).should('not.exist')
    cy.get(cesc('#page4\\/_problem1_title')).should('not.exist')
    cy.get(cesc('#page4\\/_p1')).should('not.exist')
    cy.get(cesc('#page4\\/_problem2_title')).should('not.exist')
    cy.get(cesc('#page4\\/_title1')).should('not.exist')
    cy.get(cesc('#page4\\/_p2')).should('not.exist')
    cy.get(cesc('#page5\\/_problem1_title')).should('not.exist')
    cy.get(cesc('#page5\\/_p1')).should('not.exist')
    ...
    cy.get(cesc('#page1\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_problem1_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_problem2_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p2')).should('not.exist')
    ...
    cy.get(cesc('#page3\\/_problem2_title')).should('have.text', 'Problem 4');
    ...
    cy.get(cesc('#page4\\/_problem1_title')).should('have.text', 'Problem 5');
    cy.get(cesc('#page4\\/_p1')).should('have.text', 'The fifth problem');
    cy.get(cesc('#page4\\/_problem2_title')).should('have.text', 'Problem 6: Named problem');
    ...
    cy.get(cesc('#page5\\/_problem1_title')).should('have.text', 'Problem 7');
  ...
  it("Section numbering continues across pages", () => {
    ...
    cy.get(cesc('#page2\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_section1_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p1')).should('not.exist')
    cy.get(cesc('#page3\\/_section2_title')).should('not.exist')
    cy.get(cesc('#page3\\/_p2')).should('not.exist')
    cy.get(cesc('#page4\\/_section1_title')).should('not.exist')
    cy.get(cesc('#page4\\/_p1')).should('not.exist')
    cy.get(cesc('#page4\\/_section2_title')).should('not.exist')
    cy.get(cesc('#page4\\/_title1')).should('not.exist')
    cy.get(cesc('#page4\\/_p2')).should('not.exist')
    cy.get(cesc('#page5\\/_section1_title')).should('not.exist')
    cy.get(cesc('#page5\\/_p1')).should('not.exist')
    ...
    cy.get(cesc('#page3\\/_section1_title')).should('have.text', 'Section 3');
    cy.get(cesc('#page3\\/_p1')).should('have.text', 'The third section');
    cy.get(cesc('#page3\\/_section2_title')).should('have.text', 'Section 4');
    ...
    cy.get(cesc('#page4\\/_section1_title')).should('have.text', 'Section 5');
    cy.get(cesc('#page4\\/_p1')).should('have.text', 'The fifth section');
    cy.get(cesc('#page4\\/_section2_title')).should('have.text', 'Section 6: Named section');
    ...
    cy.get(cesc('#page5\\/_section1_title')).should('have.text', 'Section 7');
  ...
  it("Links across pages", () => {
    ...
    cy.get(cesc('#page1\\/bi')).click();
    cy.get(cesc('#page1\\/b')).should('have.text', 'false');
    ...
    cy.get(cesc('#page1\\/asideTitle')).click();

    cy.get(cesc('#page1\\/insideAside')).should('not.exist');

    cy.get(cesc('#page1\\/toAside2')).click();
    ...
    cy.get(cesc('#page1\\/aside')).scrollIntoView();
    cy.url().should('match', /#page1$/)
