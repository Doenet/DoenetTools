describe('Allow error in numbers validation tests', function () {
  ...
  it('expression with single number', () => {
    ...
    cy.get('#_answer_mathinput1_input').type('log(32x+c){enter}');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(32.04x+c){enter}');
    ...
    cy.log("shink error")
    cy.get('#_answer_mathinput1_input').clear().type('log(32.01x+c){enter}');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(32.001x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(32.0001x+c){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(31.999x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(31.99x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('log(31.9x+c){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
  ...
  it('expression with single number, absolute error', () => {
    ...
    cy.log("Enter too large an error")
    cy.get('#_answer_mathinput1_input').clear().type('log(32.002x+c){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.log("shink error")
    cy.get('#_answer_mathinput1_input').clear().type('log(32.0005x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.log("shink error further")
    cy.get('#_answer_mathinput1_input').clear().type('log(32.00005x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.log("acceptable error for full credit")
    cy.get('#_answer_mathinput1_input').clear().type('log(32.000005x+c){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.log("increase error")
    cy.get('#_answer_mathinput1_input').clear().type('log(31.99995x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.log("increase error further")
    cy.get('#_answer_mathinput1_input').clear().type('log(31.9995x+c){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.log("error too large again")
    cy.get('#_answer_mathinput1_input').clear().type('log(31.995x+c){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
  ...
  it.skip('complicated expression with three numbers', () => {
    ...
    cy.log("Submit exact answer")
    cy.get('#_answer_mathinput1_input').type('10 exp(7x^2/(3-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.log("Enter too large an error")
    cy.get('#_answer_mathinput1_input').clear().type('9.9 exp(6.9x^2/(3.1-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.log("shink error")
    cy.get('#_answer_mathinput1_input').clear().type('10.0001 exp(7.00005x^2/(2.99995-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.log("acceptable error for full credit")
    cy.get('#_answer_mathinput1_input').clear().type('10.0000001 exp(7.0000001x^2/(2.9999999-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
  ...
  it("don't ignore exponents", () => {
    ...
    cy.log("Submit exact answer")
    cy.get('#_answer_mathinput1_input').type('10x^2-4{enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    cy.get('#_answer_mathinput2_input').type('10x^2-4{enter}');
    ...
    cy.log("Enter too large an error")
    cy.get('#_answer_mathinput1_input').clear().type('10.002x^2.0004-4.0008{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    cy.get('#_answer_mathinput2_input').clear().type('10.002x^2.0004-4.0008{enter}');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10.002x^2-4.0008{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    cy.get('#_answer_mathinput2_input').clear().type('10.002x^2-4.0008{enter}');
    cy.get('#_answer_mathinput2_correct').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10.0002x^2-4.00008{enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    cy.get('#_answer_mathinput2_input').clear().type('10.0002x^2-4.00008{enter}');
    cy.get('#_answer_mathinput2_correct').should('be.visible');
  ...
  it('symbolic, complicated expression with three numbers', () => {
    ...
    cy.log("Submit exact answer")
    cy.get('#_answer_mathinput1_input').type('10000 exp(7x^2/(0.00003-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('9999 exp(7x^2/(0.00003-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10000 exp(7.0001x^2/(0.00003-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10000 exp(7x^2/(0.0000300005-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('9999.91 exp(7.00005x^2/(0.0000300002-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('9999.991 exp(7.000005x^2/(0.00003000002-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.log("acceptable error for full credit")
    cy.get('#_answer_mathinput1_input').clear().type('9999.9991 exp(7.0000005x^2/(0.000030000002-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
  ...
  it('symbolic, complicated expression with three numbers, absolute error', () => {
    ...
    cy.log("Enter too large an error in first number")
    cy.get('#_answer_mathinput1_input').clear().type('9999.9999 exp(7x^2/(0.00003-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.log("Enter too large an error in second number")
    cy.get('#_answer_mathinput1_input').clear().type('10000 exp(7.00002x^2/(0.00003-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.log("Enter too large an error in third number")
    cy.get('#_answer_mathinput1_input').clear().type('10000 exp(7x^2/(0.00005-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.log("partial credit error in each")
    cy.get('#_answer_mathinput1_input').clear().type('9999.999991 exp(7.000005x^2/(0.000032-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '60 %');
    ...
    cy.log("higher partial credit error in each")
    cy.get('#_answer_mathinput1_input').clear().type('9999.9999991 exp(7.0000005x^2/(0.0000302-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_partial').should('have.text', '80 %');
    ...
    cy.log("acceptable error for full credit")
    cy.get('#_answer_mathinput1_input').clear().type('9999.99999991 exp(7.00000005x^2/(0.00003002-sqrt(y))){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
  ...
  it("symbolic, don't ignore exponents", () => {
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10x^2.0004-4{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    cy.get('#_answer_mathinput2_input').clear().type('10x^2.0004-4{enter}');
    cy.get('#_answer_mathinput2_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('10x^2.0001-4{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    cy.get('#_answer_mathinput2_input').clear().type('10x^2.0001-4{enter}');
    cy.get('#_answer_mathinput2_correct').should('be.visible');
  ...
  it('symbolic, no simplification', () => {
    ...
    cy.log("Submit exact answer")
    cy.get('#_answer_mathinput1_input').type('2.15234262pi+e*25.602348230{enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('pi2.15234262+e*25.602348230{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('76.35618172248981{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('2.15pi+e*25.602348230{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('2.152 3.142 + 2.718*25.6{enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
  ...
  it('symbolic, evaluate numbers, preserve order', () => {
    ...
    cy.log("Submit exact answer")
    cy.get('#_answer_mathinput1_input').type('sin(2pi+1x+4x+pi+6){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.log("Reordering not allowed")
    cy.get('#_answer_mathinput1_input').clear().type('sin(2pi+pi+1x+4x+6){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('sin(2pi+5x+pi+6){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
    ...
    cy.get('#_answer_mathinput1_input').clear().type('sin(6.28318+x+4x+9.14159){enter}');
    cy.get('#_answer_mathinput1_correct').should('be.visible');
    ...
    cy.log("Round too much")
    cy.get('#_answer_mathinput1_input').clear().type('sin(6.28318+x+4x+9.14{enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
  ...
  it('symbolic, evaluate numbers', () => {
    ...
    cy.log("Round too much")
    cy.get('#_answer_mathinput1_input').clear().type('sin(x+15.4+4x){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
  ...
  it('symbolic, full simplification', () => {
    ...
    cy.log("Round too much")
    cy.get('#_answer_mathinput1_input').clear().type('sin(15.4+5x){enter}');
    cy.get('#_answer_mathinput1_incorrect').should('be.visible');
