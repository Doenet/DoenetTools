describe('Circle Tag Tests', function () {
  ...
  <graph>
    <circle radius="2">
      <center>
        <x>1</x>
        <y><copy prop="diameter" tname="_circle1" /></y>
      </center>
    </circle>
    <copy prop="center" tname="_circle1" />
  </graph>
  `}, "*");
    ...
    cy.window().then((win) => {
      ...
      expect(components['/_copy2'].replacements[0].stateValues.coords.tree).eqls(["vector", -3, 6])
    })

    cy.log("move center point");
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components['/_copy2'].replacements[0].movePoint({ x: 8, y: 4 });
      expect(components['/_circle1'].stateValues.center.map(x=>x.tree)).eqls([8, 4]);
      expect(components['/_circle1'].stateValues.radius.tree).eq(2);
      expect(components['/_circle1'].stateValues.diameter.tree).eq(4);
      expect(components['/_copy2'].replacements[0].stateValues.coords.tree).eqls(["vector", 8, 4])
    })
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components['/_copy2'].replacements[0].movePoint({ x: 1, y: 8 });
      ...
      expect(components['/_copy2'].replacements[0].stateValues.coords.tree).eqls(["vector", 1, 8])
    })
  ...
  <graph>
    <circle>
      <center>
        <x>1</x>
        <y><extract prop="x"><copy prop="center" tname="_circle1"/></extract>+1</y>
      </center>
    </circle>
    <copy prop="center" tname="_circle1" />
  </graph>
  ...
  <graph>
    <circle>
      <through hide="false">
        <point>(1,2)</point>
        <point>
        <x><extract prop="x"><copy prop="throughPoint1" tname="_circle1" /></extract>+1</x>
        <y>3</y>
        </point>
      </through>
    </circle>
  ...
  <graph>
    <circle>
      <through hide="false">
        <point>
        <x><extract prop="x"><copy prop="throughPoint2" tname="_circle1" /></extract>+1</x>
        <y>3</y>
        </point>
        <point>(1,2)</point>
        <point>
  ...
  <graph>
    <circle/>
    <point>
     <x><extract prop="y"><copy prop="center" tname="_circle1" /></extract></x>
     <y><extract prop="x"><copy prop="center" tname="_circle1" /></extract></y>
    </point>
    <copy prop="center" name="centerPoint" tname="_circle1" />
  </graph>
  `}, "*");
