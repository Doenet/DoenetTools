describe('Sectioning Tag Tests', function () {
  ...
  it('sections default to not aggregating scores', () => {
    ...
    cy.window().then((win) => {
      ...
      let s1CaAnchor = "#" + components["/s1Ca"].replacements[0].componentName;
      let s1PcaAnchor = "#" + components["/s1Pca"].replacements[0].componentName;
      let s2CaAnchor = "#" + components["/s2Ca"].replacements[0].componentName;
      let s2PcaAnchor = "#" + components["/s2Pca"].replacements[0].componentName;
      let s21CaAnchor = "#" + components["/s21Ca"].replacements[0].componentName;
      let s21PcaAnchor = "#" + components["/s21Pca"].replacements[0].componentName;
      let s22CaAnchor = "#" + components["/s22Ca"].replacements[0].componentName;
      let s22PcaAnchor = "#" + components["/s22Pca"].replacements[0].componentName;
      let s221CaAnchor = "#" + components["/s221Ca"].replacements[0].componentName;
      let s221PcaAnchor = "#" + components["/s221Pca"].replacements[0].componentName;
      let s222CaAnchor = "#" + components["/s222Ca"].replacements[0].componentName;
      let s222PcaAnchor = "#" + components["/s222Pca"].replacements[0].componentName;
