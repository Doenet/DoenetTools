...
describe('GenerateRandomNumbers Tag Tests', function () {
  ...
  it.skip('no parameters, generate single random number from 1 to 10', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate single random number from 1 to 6', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate single random number from -3 to 5', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate single random number from -3 to 5, excluding 0', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate single odd random number from -3 to 5', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate two even random numbers from -4 to 4, excluding 0', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate five even random numbers with replacement from -4 to 4, excluding 0', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate five continuous random numbers, no parameters, between 0 and 1', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate ten continuous random numbers, between -3 and -2', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate twenty continuous standard normals, no parameters', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate twenty continuous standard normals, mean 100, standard deviation 10', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate twenty continuous standard normals, mean -3, variance 0.01', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate single number, assign name', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate multiple random numbers, assign names', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
  ...
  it.skip('generate multiple random numbers, assign names, new namespace', () => {
    cy.window().then((win) => {
      win.postMessage({
        doenetML: `
    <text>a</text>
