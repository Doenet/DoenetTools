...
describe('SolveEquations Tag Tests', function () {
  ...
  `}, "*");
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.solutions.map(x => x.tree)).eqls(["i", ["-", "i"]])
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2)
      expect(stateVariables['/solve'].stateValues.solutions.map(x => x.tree)).eqls(
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2)
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(0.111833, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(3.57715, 1E-5)
    })
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.solutions.map(x => x.tree)).eqls([0])
    })
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-0.870457, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(-0.657084, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[2].tree).closeTo(-0.311147, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[3].tree).closeTo(0, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[4].tree).closeTo(0.311147, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[5].tree).closeTo(0.657084, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[6].tree).closeTo(0.870457, 1E-6)
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2)
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-0.1, 1E-6)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(0, 1E-6)
    })
  ...
  `}, "*");
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2)
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(0.111833, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(3.57715, 1E-4)
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(1)
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(3.57715, 1E-4)
    })
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(0, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(0.311147, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[2].tree).closeTo(0.657084, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[3].tree).closeTo(0.870457, 1E-5)
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(7)
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-0.870457, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(-0.657084, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[2].tree).closeTo(-0.311147, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[3].tree).closeTo(0, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[4].tree).closeTo(0.311147, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[5].tree).closeTo(0.657084, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[6].tree).closeTo(0.870457, 1E-5)
    })
    ...
    cy.window().then(async (win) => {
      ...
      for (let i = 0; i < 21; i++) {
        expect(stateVariables['/solve'].stateValues.solutions[i].tree).closeTo(i - 10, 1E-3)
      }
    })
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2);
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(0, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(0.001, 1E-5)
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2);
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-0.0301, 1E-5)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(-0.03, 1E-5)
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(4);
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-4.52365, 1E-4)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(-4.52352, 1E-4)
      expect(stateVariables['/solve'].stateValues.solutions[2].tree).closeTo(8.58230, 1E-4)
      expect(stateVariables['/solve'].stateValues.solutions[3].tree).closeTo(8.58263, 1E-4)
    })
    ...
    cy.window().then(async (win) => {
      ...
      for (let i = 0; i < 10; i++) {
        expect(stateVariables['/solve'].stateValues.solutions[i].tree).closeTo(2 * i - 9, 1E-3)
      }
    })
    ...
    cy.window().then(async (win) => {
      ...
      for (let i = 0; i < 11; i++) {
        expect(stateVariables['/solve'].stateValues.solutions[i].tree).closeTo(2 * i - 10, 1E-3)
      }
    })
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(1);
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(Math.PI, 1E-3)
    })
    ...
    cy.window().then(async (win) => {
      ...
      expect(stateVariables['/solve'].stateValues.numberSolutions).eq(2);
      expect(stateVariables['/solve'].stateValues.solutions[0].tree).closeTo(-Math.PI, 1E-3)
      expect(stateVariables['/solve'].stateValues.solutions[1].tree).closeTo(Math.PI, 1E-3)
    })
