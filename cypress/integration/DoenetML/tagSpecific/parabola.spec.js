...
describe('Parabola Tag Tests', function () {
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect((stateVariables['/_parabola1'].stateValues.equation).equals(equationExpression)).eq(true);
          expect((stateVariables['/_parabola1'].stateValues.vertex)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((stateVariables['/_parabola1'].stateValues.vertex)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.a).closeTo(a, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.b).closeTo(b, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.c).closeTo(c, 1E-12);
          expect((stateVariables['/p2'].replacements[0].stateValues.equation).equals(equationExpression)).eq(true);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect(stateVariables['/e2'].replacements[0].stateValues.value.equals(equationExpression)).eq(true);
      ...
      cy.window().then(async (win) => {
        let stateVariables = await win.returnAllStateVariables1();
        await stateVariables['/v'].replacements[0].movePoint({ x: -2, y: 1 })
      ...
      cy.window().then(async (win) => {
        let stateVariables = await win.returnAllStateVariables1();
        await stateVariables['/v2'].replacements[0].movePoint({ x: 5, y: -6 })
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect((await vertex3.stateValues.xs)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((await vertex3.stateValues.xs)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect((stateVariables['/_point1'].stateValues.xs)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((stateVariables['/_point1'].stateValues.xs)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
        })
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect((await vertex3.stateValues.xs)[0].evaluate_numbers().tree).closeTo(vertex_x, 1E-12);
          expect((await vertex3.stateValues.xs)[1].evaluate_numbers().tree).closeTo(vertex_y, 1E-12);
          expect((stateVariables["/_point1"].stateValues.xs)[0].evaluate_numbers().tree).closeTo(x1, 1E-12);
          expect((stateVariables["/_point1"].stateValues.xs)[1].evaluate_numbers().tree).closeTo(y1, 1E-12);
          expect((stateVariables["/_point2"].stateValues.xs)[0].evaluate_numbers().tree).closeTo(x2, 1E-12);
          expect((stateVariables["/_point2"].stateValues.xs)[1].evaluate_numbers().tree).closeTo(y2, 1E-12);
        })
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect((stateVariables['/_parabola1'].stateValues.vertex).map(x => x.tree)).eqls(["\uff3f", "\uff3f"]);
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[0].tree).eq("\uff3f");
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[1].tree).eq("\uff3f");
          assert.isNaN(stateVariables['/p2'].replacements[0].stateValues.a);
          assert.isNaN(stateVariables['/p2'].replacements[0].stateValues.b);
          assert.isNaN(stateVariables['/p2'].replacements[0].stateValues.c);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex).map(x => x.tree)).eqls(["\uff3f", "\uff3f"]);
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[0].tree).eq("\uff3f");
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[1].tree).eq("\uff3f");
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect(stateVariables['/_parabola1'].stateValues.c).closeTo(c, 1E-12);
          expect((stateVariables['/_parabola1'].stateValues.equation).equals(equationExpression)).eq(true);
          expect((stateVariables['/_parabola1'].stateValues.vertex)[0].tree).eq('\uff3f');
          expect((stateVariables['/_parabola1'].stateValues.vertex)[1].tree).eq('\uff3f');
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[0].tree).eq('\uff3f');
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[1].tree).eq('\uff3f');
          expect(stateVariables['/p2'].replacements[0].stateValues.a).closeTo(a, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.b).closeTo(b, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.c).closeTo(c, 1E-12);
          expect((stateVariables['/p2'].replacements[0].stateValues.equation).equals(equationExpression)).eq(true);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[0].tree).eq('\uff3f');
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[1].tree).eq('\uff3f');
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[0].tree).eq('\uff3f');
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[1].tree).eq('\uff3f');
          expect(stateVariables['/e2'].replacements[0].stateValues.value.equals(equationExpression)).eq(true);
          expect(parabola3.stateValues.a).closeTo(a, 1E-12);
          ...
          expect((stateVariables["/_point2"].stateValues.xs)[0].evaluate_numbers().tree).closeTo(x2, 1E-12);
          expect((stateVariables["/_point2"].stateValues.xs)[1].evaluate_numbers().tree).closeTo(y2, 1E-12);
          expect((stateVariables["/_point3"].stateValues.xs)[0].evaluate_numbers().tree).closeTo(x3, 1E-12);
          expect((stateVariables["/_point3"].stateValues.xs)[1].evaluate_numbers().tree).closeTo(y3, 1E-12);
        })
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        ...
        cy.window().then(async (win) => {
          ...
          expect(stateVariables['/_parabola1'].stateValues.b).closeTo(b, 1E-12);
          expect(stateVariables['/_parabola1'].stateValues.c).closeTo(c, 1E-12);
          expect((stateVariables['/_parabola1'].stateValues.vertex)[0].tree).eq(vertex_x);
          expect((stateVariables['/_parabola1'].stateValues.vertex)[1].tree).eq(vertex_y);
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[0].tree).eq(vertex_x);
          expect((stateVariables['/v'].replacements[0].stateValues.xs)[1].tree).eq(vertex_y);
          expect(stateVariables['/p2'].replacements[0].stateValues.a).closeTo(a, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.b).closeTo(b, 1E-12);
          expect(stateVariables['/p2'].replacements[0].stateValues.c).closeTo(c, 1E-12);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[0].tree).eq(vertex_x);
          expect((stateVariables['/p2'].replacements[0].stateValues.vertex)[1].tree).eq(vertex_y);
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[0].tree).eq(vertex_x);
          expect((stateVariables['/v2'].replacements[0].stateValues.xs)[1].tree).eq(vertex_y);
          expect(parabola3.stateValues.a).closeTo(a, 1E-12);
          expect(parabola3.stateValues.b).closeTo(b, 1E-12);
          expect(parabola3.stateValues.c).closeTo(c, 1E-12);
  ...
  it('constrain to parabola', () => {
    ...
    cy.window().then(async (win) => {
      let stateVariables = await win.returnAllStateVariables1();
      let A3 = stateVariables["/g3"].activeChildren[1];

      let [x1, x2] = stateVariables["/A"].stateValues.xs.map(x => x.tree);
      let [x12, x22] = stateVariables["/A2"].stateValues.xs.map(x => x.tree);
      ...
      [x1, x2] = stateVariables["/A"].stateValues.xs.map(x => x.tree);
      [x12, x22] = stateVariables["/A2"].stateValues.xs.map(x => x.tree);
