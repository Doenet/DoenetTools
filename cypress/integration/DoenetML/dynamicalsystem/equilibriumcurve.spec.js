...
describe('Equilibriumcurve Tag Tests', function () {
  ...
  it('equilibriumcurve change stable', () => {
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components["/g/A"].actions.switchCurve();
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components["/g2/A"].actions.switchCurve();
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components["/g/B"].actions.switchCurve();
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components["/g2/C"].actions.switchCurve();
    ...
    cy.window().then((win) => {
      let components = Object.assign({}, win.state.components);
      components["/g2/D"].actions.switchCurve();
