...
export async function revertToRevision({
  ...
  await createContentRevision({
    ...
    note: `Save point before reverting to revision: ${revision.revisionName}`,
    autoGenerated: false,
  ...
  // Create a manual revision beforehand, so it will be seen.
  ...
  await createContentRevision({
    ...
    note: `Reverted to revision: ${revision.revisionName}`,
    autoGenerated: false,
    renameMatching: false,
  });
