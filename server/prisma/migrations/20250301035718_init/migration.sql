...
-- AddForeignKey
ALTER TABLE `activityState` ADD CONSTRAINT `activityState_contentId_fkey` FOREIGN KEY (`contentId`) REFERENCES `content`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
