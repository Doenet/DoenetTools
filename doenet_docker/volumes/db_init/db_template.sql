...
INSERT INTO `assignment` VALUES (488,'doenetId','driveId','2021-06-04 08:20:07',NULL,NULL,'2021-06-09 08:20:07',101000,2,NULL,'m',0,'l',0,0,1,1,1,1,1,1,0,NULL);
...
CREATE TABLE `course_content` (
  ...
  `parentDoenetId` char(21) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_assignment` (
  ...
  `cidOverride` char(64) DEFAULT NULL COMMENT 'NULL means no override',
...
-- Dump completed on 2022-03-08 21:39:49
