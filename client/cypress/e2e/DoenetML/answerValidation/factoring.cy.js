...
describe("factor polynomial tests", function () {
  ...
  it("factor x^2-1", () => {
    ...
    cy.log("x^2-1");
    cy.get(cesc("#\\/ans") + " textarea").type("x^2{rightArrow}-1{enter}", {
      force: true,
    });
    ...
    cy.get(cesc("#\\/ans") + " textarea").type("{home}-{enter}", {
      force: true,
    });
    cy.get(cesc("#\\/check_submit")).click();
    cy.get(cesc("#\\/check_correct")).should("be.visible");
  ...
  it("factor 4x^2-4", () => {
    ...
    cy.log("4x^2-4");
    cy.get(cesc("#\\/ans") + " textarea").type("4x^2{rightArrow}-4{enter}", {
      force: true,
    });
    cy.get(cesc("#\\/check_submit")).click();
    cy.get(cesc("#\\/check_incorrect")).should("be.visible");
