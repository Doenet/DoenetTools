...
describe("BooleanList Tag Tests", function () {
  ...
  it("copy booleanlist and overwrite maximum number", () => {
    ...
    cy.window().then(async (win) => {
      ...
      cy.window().then(async (win) => {
        let stateVariables = await win.returnAllStateVariables1();
        expect(stateVariables["/bl1"].stateValues.booleans).eqls([
          true,
          true,
          false,
          true,
        ...
        expect(stateVariables["/bl2"].stateValues.booleans).eqls([
          true,
          true,
          false,
        ]);
        expect(stateVariables["/bl3"].stateValues.booleans).eqls([
          true,
          true,
          false,
          true,
        ...
        expect(stateVariables["/bl4"].stateValues.booleans).eqls([
          true,
          true,
          false,
        ]);
        expect(stateVariables["/bl5"].stateValues.booleans).eqls([
          true,
          true,
          false,
          true,
        ]);
        expect(stateVariables["/bl6"].stateValues.booleans).eqls([
          true,
          true,
          false,
          true,
