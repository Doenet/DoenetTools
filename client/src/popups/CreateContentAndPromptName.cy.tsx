...
describe("CreateContentAndPromptName component tests", () => {
  ...
  it("shows 'Open problem set' button for sequence type", () => {
    ...
    cy.get('[data-test="Go to Created"]').should("contain", "Open problem set");
  });
  ...
  it("shows error message when name save fails", () => {
    ...
    cy.contains("An error occurred while saving the name").should("be.visible");
  });
