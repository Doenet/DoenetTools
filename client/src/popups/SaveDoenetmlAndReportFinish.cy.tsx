...
describe("SaveDoenetmlAndReportFinish component tests", () => {
  ...
  it("displays success state when save completes", () => {
    ...
    cy.get('[data-test="Copy Header"]').should("contain.text", "Save finished");
  ...
  it("handles undefined user", () => {
    ...
    cy.get("@navigate").should("have.been.calledWith", "/activities/undefined");
  });
