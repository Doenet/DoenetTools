import{r as l,j as t,a as n,i as j,a7 as ee,a8 as te,s as b,l as K,m as G,y as ae,v as q,k as P,p as ne,F as O,B as L,N as ie,a9 as W,D as re,d as le}from"./index-20518b4a.js";import{B as V}from"./ButtonGroup-37b52a8b.js";const oe=b.input`
...
`,he=b.div`
    ...
    align-items: center;
`;function ue(e){const[m,g]=l.useState(""),[h,o]=l.useState("hidden"),w=e.label?"static":"none",y=e.vertical?"static":"flex",[R,_]=l.useState(e.noSearchButton?80:26),S=e.alert?e.alert:null,C=l.useRef(0);l.useEffect(()=>{if(C){let f=document.querySelector("#searchbar").clientWidth;setTimeout(function(){_(f-(e.noSearchButton?23:77)-(e.width?90:0))},1e3)}},[C,e]);var F={margin:"6px 0px 0px 6px",position:"absolute",zIndex:"1",color:"var(--canvastext)",overflow:"hidden"},I="";e.disabled&&(I="disabled");var x=t(de,{disabled:I,alert:S,onClick:A,children:"Search"}),p="";e.width&&(p=e.width),e.noSearchButton&&(x="");var k="Search...";e.placeholder&&(k=e.placeholder);var E="";e.label&&(E=e.label);let B=!1;e.autoFocus&&(B=!0);function $(){g(""),o("hidden"),e.onChange&&e.onChange("")}function M(i){let f=i.target.value;g(f),o(f===""?"hidden":"visible"),e.onChange&&e.onChange(f)}function z(i){e.onBlur&&e.onBlur(i)}function D(i){e.onKeyDown&&e.onKeyDown(i)}function A(){e.onSubmit&&e.onSubmit(m)}return n(he,{align:y,width:p,children:[t(ce,{id:"search-label",labelVisible:w,align:y,children:E}),n("div",{style:{display:"table-cell"},children:[t(j,{icon:ee,style:F}),t(se,{"aria-label":"Clear",ref:C,cancelShown:h,marginLeft:R,onClick:()=>{$()},children:t(j,{icon:te})}),t(oe,{id:"searchbar",type:"text",width:p,noSearchButton:e.noSearchButton,placeholder:k,onChange:M,onBlur:i=>{z(i)},onKeyDownCapture:i=>{D(i)},disabled:I,alert:S,value:m,onKeyDown:i=>{(i.key==="Enter"||i.key==="Spacebar"||i.key===" ")&&A()},autoFocus:B,"aria-labelledby":"search-label","aria-disabled":!!e.disabled}),t("div",{style:{padding:"3px",display:"inline"}}),x]})]})}const me=b.div`
  padding: 1rem;
  table {
