import { a as arrayMethodIsStrict, _ as _export, b as arrayIncludes, e as engineUserAgent, g as global_1, i as isCallable, c as engineIsNode, f as functionBindContext, d as fails, h as documentCreateElement, j as html$2, k as internalMetadata, l as isObject$1, m as freezing, o as objectSetPrototypeOf, n as fixRegexpWellKnownSymbolLogic, r as requireObjectCoercible, p as getMethod, t as toString_1, q as anObject, s as regexpExecAbstract, u as advanceStringIndex, v as toLength, w as toIndexedObject, x as lengthOfArrayLike, y as toIntegerOrInfinity, z as ownKeys$8, A as createProperty, B as descriptors, C as objectGetOwnPropertyDescriptor } from './es.string.starts-with-d5b5fac4.js';
import { h as hooks } from './moment-613ac161.js';
...
function _injectProductInfo(key, element) {
  ...
  if (hasValidType || isNonCommercial || schemaValidity) {
    if (schemaValidity) {
      var releaseDate = hooks("13/01/2022", "DD/MM/YYYY");
...
var BottomLeftCornerOverlayTable = /* @__PURE__ */ function(_Table) {
  ...
  return _createClass$n(BottomLeftCornerOverlayTable2);
}(Table);
...
var BottomLeftCornerOverlay = /* @__PURE__ */ function(_Overlay) {
  ...
  _createClass$q(BottomLeftCornerOverlay2, [{
    key: "createTable",
...
var BottomOverlayTable = /* @__PURE__ */ function(_Table) {
  ...
  return _createClass$r(BottomOverlayTable2);
}(Table);
...
var LeftOverlayTable = /* @__PURE__ */ function(_Table) {
  ...
  return _createClass$t(LeftOverlayTable2);
}(Table);
...
var TopLeftCornerOverlayTable = /* @__PURE__ */ function(_Table) {
  ...
  return _createClass$v(TopLeftCornerOverlayTable2);
}(Table);
...
var TopLeftCornerOverlay = /* @__PURE__ */ function(_Overlay) {
  ...
  _createClass$w(TopLeftCornerOverlay2, [{
    key: "createTable",
    value: function createTable() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
...
var TopOverlayTable = /* @__PURE__ */ function(_Table) {
  ...
  return _createClass$x(TopOverlayTable2);
}(Table);
...
function isNumeric(value) {
  ...
  if (type === "number") {
    ...
    var delimiter = Array.from(new Set(["."].concat(_toConsumableArray$6(additionalDelimiters)))).map(function(d) {
      return "\\".concat(d);
    }).join("|");
...
function createPriorityMap() {
  ...
  function getItems() {
    ...
    return _toConsumableArray$7(priorityMap).sort(function(a, b) {
...
function createUniqueMap() {
  ...
  function getItems() {
    return _toConsumableArray$8(uniqueMap);
  }
  function hasItem(id) {
...
function createUniqueSet() {
  ...
  function getItems() {
    return _toConsumableArray$9(uniqueSet);
  }
  return {
    addItem,
    getItems
...
function getPluginsNames() {
  return [].concat(_toConsumableArray$a(priorityPluginsQueue.getItems()), _toConsumableArray$a(uniquePluginsQueue.getItems()));
}
...
var TableView = /* @__PURE__ */ function() {
  ...
  _createClass$K(TableView2, [{
    ...
    value: function translateFromRenderableToVisualCoords(_ref) {
      ...
      return _construct$5(CellCoords, _toConsumableArray$b(this.translateFromRenderableToVisualIndex(row, col)));
    }
  }, {
    ...
    value: function initializeWalkontable() {
      ...
      var walkontableConfig = {
        ...
        data: function data(renderableRow, renderableColumn) {
          var _this2$instance;
          return (_this2$instance = _this2.instance).getDataAtCell.apply(_this2$instance, _toConsumableArray$b(_this2.translateFromRenderableToVisualIndex(renderableRow, renderableColumn)));
        },
...
function getListWithInsertedItems(indexedValues, insertionIndex, insertedIndexes, insertedValuesMapping) {
  ...
  return [].concat(_toConsumableArray$c(indexedValues.slice(0, firstInsertedIndex)), _toConsumableArray$c(insertedIndexes.map(function(insertedIndex, ordinalNumber) {
    if (isFunction(insertedValuesMapping)) {
      return insertedValuesMapping(insertedIndex, ordinalNumber);
    }
    return insertedValuesMapping;
  })), _toConsumableArray$c(firstInsertedIndex === void 0 ? [] : indexedValues.slice(firstInsertedIndex)));
}
...
var PhysicalIndexToValueMap = /* @__PURE__ */ function(_IndexMap) {
  ...
  _createClass$N(PhysicalIndexToValueMap2, [{
    key: "insert",
...
function getListWithInsertedItems$1(indexedValues, insertionIndex, insertedIndexes) {
  return [].concat(_toConsumableArray$d(indexedValues.slice(0, insertionIndex)), _toConsumableArray$d(insertedIndexes), _toConsumableArray$d(indexedValues.slice(insertionIndex)));
}
...
var LinkedPhysicalIndexToValueMap = /* @__PURE__ */ function(_IndexMap) {
  ...
  _createClass$P(LinkedPhysicalIndexToValueMap2, [{
    key: "getValues",
    value: function getValues() {
      var _this2 = this;
    ...
    key: "setValues",
    value: function setValues(values) {
      this.orderOfIndexes = _toConsumableArray$e(Array(values.length).keys());
...
var IndexesSequence = /* @__PURE__ */ function(_IndexMap) {
  ...
  _createClass$R(IndexesSequence2, [{
    key: "insert",
    value: function insert(insertionIndex, insertedIndexes) {
...
var AggregatedCollection = /* @__PURE__ */ function(_MapCollection) {
  ...
  _createClass$T(AggregatedCollection2, [{
    key: "getMergedValues",
...
var ChangesObserver = /* @__PURE__ */ function() {
  ...
  _createClass$U(ChangesObserver2, [{
    key: "subscribe",
...
var ChangesObservable = /* @__PURE__ */ function() {
  function ChangesObservable2() {
    ...
    _classPrivateFieldInitSpec$1(this, _observers, {
      writable: true,
      value: new Set()
    });
    _classPrivateFieldInitSpec$1(this, _indexMatrix, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec$1(this, _currentIndexState, {
      writable: true,
      value: []
    });
    _classPrivateFieldInitSpec$1(this, _isMatrixIndexesInitialized, {
      writable: true,
      value: false
    });
    _classPrivateFieldInitSpec$1(this, _initialIndexValue, {
      writable: true,
      value: false
    });
    _classPrivateFieldSet$1(this, _initialIndexValue, initialIndexValue !== null && initialIndexValue !== void 0 ? initialIndexValue : false);
  }
  _createClass$V(ChangesObservable2, [{
    key: "createObserver",
...
function _toConsumableArray$f(arr) {
  return _arrayWithoutHoles$d(arr) || _iterableToArray$d(arr) || _unsupportedIterableToArray$h(arr) || _nonIterableSpread$d();
}
...
var IndexMapper = /* @__PURE__ */ function() {
  ...
  _createClass$W(IndexMapper2, [{
    ...
    value: function initToLength() {
      ...
      this.notTrimmedIndexesCache = _toConsumableArray$f(new Array(length).keys());
      this.notHiddenIndexesCache = _toConsumableArray$f(new Array(length).keys());
    ...
    value: function fitToLength(length) {
      ...
      if (length < currentIndexCount) {
        var indexesToBeRemoved = _toConsumableArray$f(Array(this.getNumberOfIndexes() - length).keys()).map(function(i) {
          return i + length;
        });
...
function _slicedToArray$9(arr, i) {
  return _arrayWithHoles$9(arr) || _iterableToArrayLimit$9(arr, i) || _unsupportedIterableToArray$i(arr, i) || _nonIterableRest$9();
}
...
var VisualSelection = /* @__PURE__ */ function(_Selection) {
  ...
  _createClass$X(VisualSelection2, [{
    key: "add",
    value: function add(coords) {
...
function _toConsumableArray$g(arr) {
  return _arrayWithoutHoles$e(arr) || _iterableToArray$e(arr) || _unsupportedIterableToArray$j(arr) || _nonIterableSpread$e();
}
...
var Highlight = /* @__PURE__ */ function(_Symbol$iterator) {
  ...
  _createClass$Y(Highlight2, [{
    ...
    value: function getAreas() {
      return _toConsumableArray$g(this.areas.values());
    }
  }, {
    ...
    value: function getHeaders() {
      return _toConsumableArray$g(this.headers.values());
    }
  }, {
    ...
    value: function getActiveHeaders() {
      return _toConsumableArray$g(this.activeHeaders.values());
    }
  }, {
    key: "getCustomSelections",
    value: function getCustomSelections() {
      return _toConsumableArray$g(this.customSelections.values());
    }
  }, {
    ...
    value: function value() {
      return [this.cell, this.fill].concat(_toConsumableArray$g(this.areas.values()), _toConsumableArray$g(this.headers.values()), _toConsumableArray$g(this.activeHeaders.values()), _toConsumableArray$g(this.customSelections))[Symbol.iterator]();
    }
  }]);
  return Highlight2;
}(Symbol.iterator);
...
var SelectionRange = /* @__PURE__ */ function(_Symbol$iterator) {
  ...
  _createClass$Z(SelectionRange2, [{
    key: "isEmpty",
    value: function isEmpty() {
      return this.size() === 0;
    }
...
var Transformation = /* @__PURE__ */ function() {
  ...
  _createClass$_(Transformation2, [{
    key: "transformStart",
...
function _slicedToArray$b(arr, i) {
  return _arrayWithHoles$b(arr) || _iterableToArrayLimit$b(arr, i) || _unsupportedIterableToArray$l(arr, i) || _nonIterableRest$b();
}
...
function createTableMetaEmptyClass() {
  return /* @__PURE__ */ _createClass$11(function TableMeta() {
...
var LazyFactoryMap = /* @__PURE__ */ function(_Symbol$iterator) {
  ...
  _createClass$13(LazyFactoryMap2, [{
    key: "obtain",
...
var DynamicCellMetaMod = /* @__PURE__ */ function() {
  function DynamicCellMetaMod2(metaManager) {
    var _this = this;
    _classCallCheck$17(this, DynamicCellMetaMod2);
  ...
  _createClass$17(DynamicCellMetaMod2, [{
    key: "extendCellMeta",
...
function _toConsumableArray$i(arr) {
  return _arrayWithoutHoles$g(arr) || _iterableToArray$g(arr) || _unsupportedIterableToArray$n(arr) || _nonIterableSpread$g();
}
...
function Core(rootElement, userSettings) {
  ...
  this.getDataAtCol = function(column) {
    var _ref13;
    return (_ref13 = []).concat.apply(_ref13, _toConsumableArray$i(datamap.getRange(new CellCoords(0, column), new CellCoords(tableMeta.data.length - 1, column), datamap.DESTINATION_RENDERER)));
  };
...
var TextEditor = /* @__PURE__ */ function(_BaseEditor) {
  ...
  function TextEditor2(instance) {
    var _this;
    _classCallCheck$18(this, TextEditor2);
...
export { partial as $, outerHeight as A, BaseEditor as B, Core as C, getTrimmingContainer as D, arrayMap as E, stripTags as F, isPrintableChar as G, Hooks as H, hasClass as I, EventManager as J, KEY_CODES as K, isFunctionKey as L, deepExtend as M, empty as N, removeClass as O, objectEach as P, fastInnerHTML as Q, EDITOR_STATE as R, getCssTransform as S, TextCellType as T, resetCssTransform as U, getComputedStyle as V, _register as W, baseRenderer as X, CellCoords as Y, isEmpty as Z, _register$3 as _, getLanguagesDictionaries as a, CONTEXTMENU_ITEMS_REMOVE_COLUMN as a$, isKey as a0, isNumeric as a1, rangeEach as a2, _register$1 as a3, _getEditorInstance as a4, _register$2 as a5, defineGetter as a6, getPluginsNames as a7, arrayEach as a8, hasPlugin as a9, isUndefined as aA, isFunction as aB, isPressedCtrlKey as aC, toSingleLine as aD, mixin as aE, localHooks as aF, debounce as aG, closest as aH, deepClone as aI, isChildOf as aJ, CONTEXTMENU_ITEMS_EDIT_COMMENT as aK, CONTEXTMENU_ITEMS_ADD_COMMENT as aL, CONTEXTMENU_ITEMS_REMOVE_COMMENT as aM, CONTEXTMENU_ITEMS_READ_ONLY_COMMENT as aN, CONTEXTMENU_ITEMS_ALIGNMENT as aO, CONTEXTMENU_ITEMS_ALIGNMENT_LEFT as aP, CONTEXTMENU_ITEMS_ALIGNMENT_CENTER as aQ, CONTEXTMENU_ITEMS_ALIGNMENT_RIGHT as aR, CONTEXTMENU_ITEMS_ALIGNMENT_JUSTIFY as aS, CONTEXTMENU_ITEMS_ALIGNMENT_TOP as aT, CONTEXTMENU_ITEMS_ALIGNMENT_MIDDLE as aU, CONTEXTMENU_ITEMS_ALIGNMENT_BOTTOM as aV, CONTEXTMENU_ITEMS_CLEAR_COLUMN as aW, CONTEXTMENU_ITEMS_INSERT_LEFT as aX, CONTEXTMENU_ITEMS_INSERT_RIGHT as aY, CONTEXTMENU_ITEMS_READ_ONLY as aZ, CONTEXTMENU_ITEMS_REDO as a_, hasItem$3 as aa, hasItem as ab, hasItem$1 as ac, hasItem$2 as ad, isObject as ae, PhysicalIndexToValueMap as af, hasOwnProperty as ag, isPercentValue as ah, valueAccordingPercent as ai, ViewportColumnsCalculator as aj, arrayReduce as ak, arrayFilter as al, cancelAnimationFrame as am, requestAnimationFrame as an, CellRange as ao, isVisible as ap, getIncreasedIndexes as aq, getDecreasedIndexes as ar, IndexMap as as, warn as at, arrayUnique as au, fastInnerText as av, LinkedPhysicalIndexToValueMap as aw, isRightClick as ax, staticRegister as ay, IndexesSequence as az, registerLanguageDictionary as b, dataRowToChangesArray as b$, transformSelectionToColumnDistance as b0, CONTEXTMENU_ITEMS_REMOVE_ROW as b1, transformSelectionToRowDistance as b2, CONTEXTMENU_ITEMS_ROW_ABOVE as b3, CONTEXTMENU_ITEMS_ROW_BELOW as b4, CONTEXTMENU_ITEMS_NO_ITEMS as b5, CONTEXTMENU_ITEMS_UNDO as b6, getWindowScrollTop as b7, getWindowScrollLeft as b8, getParentWindow as b9, FILTERS_CONDITIONS_EQUAL as bA, FILTERS_CONDITIONS_NOT_EQUAL as bB, FILTERS_CONDITIONS_GREATER_THAN as bC, FILTERS_CONDITIONS_GREATER_THAN_OR_EQUAL as bD, FILTERS_CONDITIONS_LESS_THAN as bE, FILTERS_CONDITIONS_LESS_THAN_OR_EQUAL as bF, FILTERS_CONDITIONS_AFTER as bG, FILTERS_CONDITIONS_BEFORE as bH, FILTERS_CONDITIONS_BETWEEN as bI, FILTERS_CONDITIONS_NOT_BETWEEN as bJ, FILTERS_CONDITIONS_BEGINS_WITH as bK, FILTERS_CONDITIONS_ENDS_WITH as bL, FILTERS_CONDITIONS_CONTAINS as bM, FILTERS_CONDITIONS_NOT_CONTAIN as bN, FILTERS_CONDITIONS_TOMORROW as bO, FILTERS_CONDITIONS_TODAY as bP, FILTERS_CONDITIONS_YESTERDAY as bQ, getComparisonFunction as bR, FILTERS_LABELS_CONJUNCTION as bS, FILTERS_LABELS_DISJUNCTION as bT, FILTERS_NAMESPACE as bU, FILTERS_BUTTONS_PLACEHOLDER_VALUE as bV, FILTERS_BUTTONS_PLACEHOLDER_SECOND_VALUE as bW, FILTERS_CONDITIONS_NAMESPACE as bX, FILTERS_BUTTONS_PLACEHOLDER_SEARCH as bY, FILTERS_BUTTONS_SELECT_ALL as bZ, FILTERS_BUTTONS_CLEAR as b_, isInput as ba, isWindowsOS as bb, isMobileBrowser as bc, isIpadOS as bd, CONTEXTMENU_ITEMS_COPY as be, CONTEXTMENU_ITEMS_CUT as bf, selectElementIfAllowed as bg, stringify$1 as bh, _dataToHTML as bi, sanitize as bj, htmlToGridSettings as bk, parse as bl, getSelectionText as bm, CONTEXTMENU_ITEMS_BORDERS_BOTTOM as bn, CONTEXTMENU_ITEMS_BORDERS_LEFT as bo, CONTEXTMENU_ITEMS_REMOVE_BORDERS as bp, CONTEXTMENU_ITEMS_BORDERS_RIGHT as bq, CONTEXTMENU_ITEMS_BORDERS_TOP as br, detectSelectionType as bs, normalizeSelectionFactory as bt, CONTEXTMENU_ITEMS_BORDERS as bu, clone as bv, substitute as bw, FILTERS_CONDITIONS_NONE as bx, FILTERS_CONDITIONS_EMPTY as by, FILTERS_CONDITIONS_NOT_EMPTY as bz, getTranslatedPhrase as c, FILTERS_VALUES_BLANK_CELLS as c0, FILTERS_BUTTONS_OK as c1, FILTERS_BUTTONS_CANCEL as c2, curry as c3, TrimmingMap as c4, FILTERS_DIVS_FILTER_BY_CONDITION as c5, FILTERS_DIVS_FILTER_BY_VALUE as c6, isArrayOfArrays as c7, error as c8, toUpperCaseFirst as c9, CONTEXTMENU_ITEMS_HIDE_COLUMN as ca, CONTEXTMENU_ITEMS_SHOW_COLUMN as cb, HidingMap as cc, CONTEXTMENU_ITEMS_HIDE_ROW as cd, CONTEXTMENU_ITEMS_SHOW_ROW as ce, CONTEXTMENU_ITEMS_FREEZE_COLUMN as cf, CONTEXTMENU_ITEMS_UNFREEZE_COLUMN as cg, isDetached as ch, ViewportRowsCalculator as ci, rangeEachReverse as cj, CONTEXTMENU_ITEMS_UNMERGE_CELLS as ck, CONTEXTMENU_ITEMS_MERGE_CELLS as cl, HEADER_TYPE as cm, ACTIVE_HEADER_TYPE as cn, isLeftClick as co, CONTEXTMENU_ITEMS_NESTED_ROWS_INSERT_CHILD as cp, CONTEXTMENU_ITEMS_NESTED_ROWS_DETACH_CHILD as cq, isArrayOfObjects as cr, isTouchSupported as cs, inherit as ct, registerPlugin as cu, dictionaryKeys as d, getListWithInsertedItems$1 as e, getListWithRemovedItems$1 as f, getLanguageDictionary as g, getListWithInsertedItems as h, getListWithRemovedItems as i, extend as j, isImmediatePropagationStopped as k, stopImmediatePropagation as l, metaSchemaFactory as m, TextEditor as n, isDefined as o, addClass as p, getScrollbarWidth as q, rootInstanceSymbol as r, setCaretPosition as s, outerWidth as t, textRenderer as u, stringify as v, getCaretPosition as w, getSelectionEndPosition as x, pivot as y, offset as z };
