...
const Un = Va, Qn = xt, Zn = function(e3, t2) {
  ...
  Un(a2, t2.world);
  let n2 = a2[0];
  return ii.test(n2.text) ? (a2[0].tag("Ordinal", "ord-range", t2.world), a2[2].tag("Ordinal", "ord-range", t2.world)) : ni.test(n2.text) ? (a2[0].tag("Cardinal", "num-range", t2.world), a2[2].tag("Cardinal", "num-range", t2.world)) : oi.test(n2.text) && (a2[0].tag("Time", "time-range", t2.world), a2[1].tag("Date", "time-range", t2.world), a2[2].tag("Time", "time-range", t2.world)), a2.forEach((e4) => {
...
var es = function e2(t2) {
  ...
  return a2.tokenize = function(e3 = "", t3) {
    ...
    return Yo(e3, t3);
  }, a2.version = "13.11.3", a2.import = a2.load, a2.plugin = a2.extend, a2;
}(new Rr());
