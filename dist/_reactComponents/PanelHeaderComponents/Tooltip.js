...
export default function Tooltip(props) {
  ...
  var icon = /* @__PURE__ */ React.createElement("b", null, "i");
  if (props.icon) {
    icon = props.icon;
  }
  const iconVisible = /* @__PURE__ */ React.createElement("div", {
    style: {fontSize: "10px"}
  }, icon);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(TooltipStyling, {
    role: "tooltip",
    onClick: (e) => {
      handleClick(e);
    },
  ...
  }, iconVisible), /* @__PURE__ */ React.createElement(ContainerStyling, {
    isVisible,
    tabIndex: "-1"
  }, text));
}
