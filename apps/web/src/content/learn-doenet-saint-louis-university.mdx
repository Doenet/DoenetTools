...
If you want to play around, the whole activity can be found <a href={`${DOENET_MAIN_URL}/activityViewer/n6XetR8XZqnn6nivQBmqmR`}>here</a>.
...
Visit <a href={DOENET_MAIN_URL}>doenet.org</a> for upcoming events, registration, and more!
